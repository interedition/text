...
import eu.interedition.text.json.JacksonDataMapper;
import java.io.File;
import java.net.URI;
...
public class H2TextRepositoryProvider implements Provider<H2TextRepository<JsonNode>> {
    ...
    public H2TextRepository<JsonNode> get() {
        ...
        try {
            ...
            return new H2TextRepository<JsonNode>(JsonNode.class, new JacksonDataMapper<JsonNode>(objectMapper), dataSource, true).withSchema();
